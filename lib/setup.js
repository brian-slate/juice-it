...
async function runSetup() {
    ...
    console.log('    • OpenAI API key (~$0.01/disc - for track analysis)');
    console.log('');
    ...
    try {
        ...
        console.log('━'.repeat(60));
        console.log('');
        console.log('  OpenAI analyzes disc tracks to match episodes.');
        console.log('  💰 Cost: ~$0.01-0.02 per disc');
        console.log('');
        ...
        if (hasTmdbKey && hasOpenAiKey) {
            ...
            console.log('');
            console.log('  💡 Run `juiceit --setup` to add missing keys.');
        } else {
            console.log('  📀 Basic Mode: Files named Track_1.mp4, Track_2.mp4, etc.');
            console.log('');
            console.log('  💡 Run `juiceit --setup` anytime to enable Smart Mode.');
        }
        ...
        console.log('');
        console.log('💡 Run `juiceit --setup` anytime to configure API keys.');
        console.log('');
