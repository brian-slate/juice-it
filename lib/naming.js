...
/**
 * Generate an extras filename for skipped tracks
 *
 * @param {string} baseFileName - Base filename
 * @param {number} trackNum - Track number
 * @returns {string} - Extras filename like "Movie Name (2024) - Extra Track 1.mp4"
 */
function buildExtrasFileName(baseFileName, trackNum) {
    return `${baseFileName} - Extra Track ${trackNum}.mp4`;
}
